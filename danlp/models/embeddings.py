...
def _process_downloaded_embeddings(tmp_file_path: str, meta_info: dict, cache_dir: str = DEFAULT_CACHE_DIR,
    ...
    if pretrained_embedding in ['news.da.wv', 'wiki.da.wv']:
        ...
        with gzip.open(tmp_file_path, 'rb', encoding="utf8") as fin, open(vec_file_path, 'wb', encoding="utf8") as fout:
        ...
        with open(org_vec_file, 'r', errors='replace', encoding="utf8") as fin, open(new_vec_file, 'w', encoding="utf8") as fout:
        ...
        with gzip.open(tmp_file_path, 'rb', encoding="utf8") as fin, open(bin_file_path, 'wb', encoding="utf8") as fout:
            shutil.copyfileobj(fin, fout)
